...
def main():
    ...
    if args.use_wandb:
        wandb.init(project="BSRD_sample_real_time", name=f'{current_time}_{args.pre_model}',config=args)
    ...
    args.output_path = os.path.join("real",'BSRD',args.pre_model,f'{current_time}')

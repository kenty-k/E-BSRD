...
class QKVFlashAttention(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # from flash_attention_v028.flash_attn.flash_attention import FlashAttention
...
class QKVAttentionLegacy(nn.Module):
    """
    A module which performs QKV attention. Matches legacy QKVAttention + input/output heads shaping without flash attention.
    """
...
class UNetModel(nn.Module):
    ...
    def convert_to_fp16(self):
        ...
        self.out.apply(convert_module_to_f16)  # 出力層も変換

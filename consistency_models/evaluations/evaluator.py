...
if __name__ == "__main__":
    main()
# CUDA_VISIBLE_DEVICES=7 python evaluator.py /consistency_models/logs/samples_300x256x256x3_gt.npz /BSRD/output_imgs/synth/Burstormer/sig_max0.03_synth_burst4/2024-12-04_19-54/samples_300x256x256x3_5_Burstormer.npz /consistency_models/bsrd-2024-06-25-05-51-09-982723/score.csv
